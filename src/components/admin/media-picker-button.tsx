  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold shrink-0 transition-all hover:shadow-[0_0_12px_rgba(201,162,39,0.25)]"
        style={{
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                <FolderOpen className="h-4 w-4" style={{ color: "#C9A227" }} />
                <h2 className="font-serif text-base font-semibold" style={{ color: "#F5F0E6" }}>
                  Banco de Imagens
                </h2>
              </div>
              <button
                onClick={() => setOpen(false)}
                className="w-7 h-7 rounded-full flex items-center justify-center transition-colors hover:bg-[rgba(201,162,39,0.1)]"
                style={{ color: "#C8BBA8" }}
              >
                <X className="h-4 w-4" />
              </button>
            ...
            <div className="overflow-auto p-6 flex-1">
              {loading ? (
                <div className="flex items-center justify-center py-16">
                  <Loader2 className="h-6 w-6 animate-spin" style={{ color: "#C9A227" }} />
                </div>
              ) : assets.length === 0 ? (
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3">
                  {assets.map((asset) => (
                    <button
                      ...
                      className="group relative rounded-xl overflow-hidden text-left transition-all hover:ring-2 hover:ring-[#C9A227] focus:outline-none focus:ring-2 focus:ring-[#C9A227]"
            ...
            >
              ...
              <a href="/admin/media" target="_blank" className="underline" style={{ color: "#C9A227" }}>
                Gerenciar banco
              </a>
            </div>
          </div>
