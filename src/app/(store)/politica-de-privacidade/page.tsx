...
export const metadata: Metadata = {
  title: "Política de Privacidade — Altheia",
  description: "Como a Altheia coleta, usa e protege seus dados pessoais conforme a LGPD.",
};
      ...
      <div className="container mx-auto max-w-3xl px-4 py-16">
        ...
        >
          <Section title="1. Quem somos">
            <p>
              Altheia Cosméticos Ltda., inscrita sob CNPJ 00.000.000/0001-00, com sede na
              Rua das Flores, 100 — Gramado, RS — Brasil ("Altheia", "nós" ou "nossos"), é a
          ...
          <Section title="2. Dados coletados">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-3">
              <li>
                <strong style={{ color: "#F5F0E6" }}>Dados de cadastro:</strong> nome, e-mail,
                senha criptografada.
              </li>
              <li>
                <strong style={{ color: "#F5F0E6" }}>Dados de pedido:</strong> endereço de
              ...
              <li>
                <strong style={{ color: "#F5F0E6" }}>Newsletter:</strong> e-mail, se você
          ...
          <Section title="4. Base legal (LGPD)">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-3">
              <li>
                <strong style={{ color: "#F5F0E6" }}>Execução de contrato:</strong> dados
                necessários para processar seus pedidos;
              </li>
              <li>
                <strong style={{ color: "#F5F0E6" }}>Consentimento:</strong> newsletter e
                cookies de análise;
              </li>
              <li>
                <strong style={{ color: "#F5F0E6" }}>Obrigação legal:</strong> emissão de nota
                fiscal;
              </li>
              <li>
                <strong style={{ color: "#F5F0E6" }}>Legítimo interesse:</strong> prevenção de
                fraudes e segurança.
              </li>
            </ul>
          </Section>
          ...
          <Section title="5. Compartilhamento de dados">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-3">
              ...
              <li>
                <strong style={{ color: "#F5F0E6" }}>Correios / transportadoras:</strong>{" "}
                entrega dos pedidos;
              </li>
              <li>
                <strong style={{ color: "#F5F0E6" }}>Vercel Inc.:</strong> hospedagem da
                plataforma;
              </li>
              <li>
                <strong style={{ color: "#F5F0E6" }}>Clerk Inc.:</strong> autenticação de
                usuários.
              </li>
            </ul>
            <p className="mt-3">
          ...
          <Section title="11. Contato e DPO">
            <p>
              ...
              <a href="mailto:dpo@altheia.com.br" style={{ color: "#C9A227" }}>
                dpo@altheia.com.br
              </a>
              <br />
