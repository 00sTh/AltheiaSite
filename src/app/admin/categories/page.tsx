  ...
  return (
    <div className="space-y-8">
      ...
      <div
        ...
        style={{ border: "1px solid rgba(201,162,39,0.15)", backgroundColor: "#0A2419" }}
      >
        {categories.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            <Tag className="h-10 w-10" style={{ color: "rgba(201,162,39,0.3)" }} />
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      {cat.imageUrl ? (
                        ...
                        >
                          <Tag className="h-4 w-4" style={{ color: "rgba(201,162,39,0.6)" }} />
                        </div>
                      )}
                      <span className="font-medium text-sm" style={{ color: "#F5F0E6" }}>
                        {cat.name}
                      </span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <code className="text-xs px-2 py-1 rounded" style={{ backgroundColor: "rgba(201,162,39,0.08)", color: "#C9A227" }}>
                      {cat.slug}
                    </code>
                  </td>
